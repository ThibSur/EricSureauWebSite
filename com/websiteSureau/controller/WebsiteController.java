...
public class WebsiteController {
	...
	public String index(Model model) {
    	...
    	Iterable<SiteNews> siteNews = newsService.getNews();
    	
    	ArrayList<String> siteNewsDate = newsService.getNewsDate(siteNews);
	    String[] dateInLetters = calendarService.getDateinLetters(siteNewsDate);
	...
	public String admin(Model model) {
		...
		Iterable<SiteNews> listSiteNews = newsService.getNews();
	...
	public String showDrawings(Model model, @RequestParam int type)  {
	    ...
	    String[] dateInLetters = calendarService.getDateinLetters(drawingsDate);
