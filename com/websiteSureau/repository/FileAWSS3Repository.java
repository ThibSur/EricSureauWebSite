...
@Service
public class FileAWSS3Repository {
    ...
    public void saveFile(final MultipartFile multipartFile, String path) {
        try {
            final File file = convertMultiPartFileToFile(multipartFile);
            final String fileName = file.getName();
            LOG.info("Uploading file with name {}", fileName);
            final PutObjectRequest putObjectRequest = new PutObjectRequest(s3BucketName, path + fileName, file);
